...
public class Question02 {
    public static void main(String[] args) {
        ...
        //Klavyeden gireceğimiz plaka numarasına göre ilgili ili gösteren uygulamayı
        //yazalım
        ...
        System.out.println("girilen plaka numarasi"+ arr[plaka] + "aittir");
